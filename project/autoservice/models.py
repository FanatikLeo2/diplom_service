...
class Maintenance(models.Model):
    ...
    maintenance_type = models.ForeignKey(to=MaintenanceType, on_delete=models.CASCADE, related_name='maintenance_type')
    ...
    service_company = models.ForeignKey(to=ServiceCompany, on_delete=models.CASCADE, related_name='maintenance_service_company')
